...
#define CUSTOM_MACHINE_NAME "SKR-mini-E3-V1.2-BLTouch"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 110.2 }
...
#define LEVEL_BED_CORNERS // Super handy to quickly level your bed over the 4 corners
